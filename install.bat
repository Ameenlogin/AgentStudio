...
echo         Installing the agent Chrome browser (Playwright)...
"%VENV_PY%" -m playwright install chromium || echo         (Chromium download failed; run later: playwright install chromium)
